        ...
        let answer = vec![
            vec![
                Some(SquareInfoObj {
                    ...
                    square: SquareStr::A8,
                    r#type: others::PieceSymbol::R,
                }),
                Some(SquareInfoObj {
                    color: others::ColorChar::B,
                    square: SquareStr::B8,
                    r#type: others::PieceSymbol::N,
                }),
                Some(SquareInfoObj {
                    color: others::ColorChar::B,
                    square: SquareStr::C8,
                    r#type: others::PieceSymbol::B,
                }),
                Some(SquareInfoObj {
                    color: others::ColorChar::B,
                    square: SquareStr::D8,
                    r#type: others::PieceSymbol::Q,
                }),
                Some(SquareInfoObj {
                    color: others::ColorChar::B,
                    square: SquareStr::E8,
                    r#type: others::PieceSymbol::K,
                }),
                Some(SquareInfoObj {
                    color: others::ColorChar::B,
                    square: SquareStr::F8,
